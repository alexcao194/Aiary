...
import com.alexcao.dexpense.core.database.converters.BigIntegerConverter
...
@TypeConverters(LocalDateConverter::class, ColorConverter::class, BigIntegerConverter::class)
